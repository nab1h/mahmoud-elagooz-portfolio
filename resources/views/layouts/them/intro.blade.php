...
<div id="page" class="s-pagewrap">
    ...
    <section id="intro" class="s-intro target-section">
        ...
        <ul class="s-intro__social social-list">
            <li>
                <a href="{{ $links->where('name', 'facebook')->first()->url ?? '#' }}">
            ...
            <li>
                <a href="{{ $links->where('name', 'twiter')->first()->url ?? '#' }}">
            ...
            <li>
                <a href="{{ $links->where('name', 'instagram')->first()->url ?? '#' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        style="fill:rgba(0, 0, 0, 1);transform:;-ms-filter:">
                        <path
            ...
            <li>
                <a href="{{ $links->where('name', 'linkedin')->first()->url ?? '#' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        style="fill:rgba(0, 0, 0, 1);transform:;-ms-filter:">
                        <circle cx="4.983" cy="5.009" r="2.188"></circle>
                        <path
                            d="M9.237,8.855v12.139h3.769v-6.003c0-1.584,0.298-3.118,2.262-3.118c1.937,0,1.961,1.811,1.961,3.218v5.904H21v-6.657 c0-3.27-0.704-5.783-4.526-5.783c-1.835,0-3.065,1.007-3.568,1.96h-0.051v-1.66H9.237z M2.857,20.994h3.763V8.855H2.857V20.994z">
                        </path>
                    </svg>
            ...
            <li>
                <a href="{{ $links->where('name', 'pintrest')->first()->url ?? '#' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;">
                        <path
        ...
        <div class="s-intro__content-media">
            <img src="{{ asset('them/images/intro-bg.jpg') }}"
                srcset="{{ asset('them/images/intro-bg.jpg') }} 1x, {{ asset('them/images/intro-bg.jpg') }} 2x"
                alt="Homepage Intro Background">
        </div> <!-- s-intro__content-media -->

        <div class="s-intro__btn-download">
            @if ($cvFile)

                <a class="btn btn--stroke" href="{{ route('cv_file.download') }}">Get My CV</a>
            @else
