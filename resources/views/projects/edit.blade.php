            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('projects.update', $project) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="description" class="form-label">Description and Key Results <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $project->photo_brand) }}" class="img-thumbnail" alt="Current Logo" width="100" >
                            </div>
                            @endif
<br>
...
<br>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                @if($project->photo_1)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $project->photo_1) }}" class="img-thumbnail" alt="{{ $project->name }}" width="100" height="100">
                                </div>
                                @endif
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                @if($project->photo_2)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $project->photo_2) }}" class="img-thumbnail" alt="{{ $project->name }}" width="100" height="100">
                                </div>
                                @endif
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                @if($project->photo_3)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $project->photo_3) }}" class="img-thumbnail" alt="{{ $project->name }}" width="100" height="100">
                                </div>
                                @endif
